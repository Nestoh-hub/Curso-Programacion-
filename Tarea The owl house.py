...
respuesta2 = input("Quieres seguir o salir corriendo?:")
if respuesta2.lower() == "seguir"or respuesta2.lower() == "quiero seguir":
...
elif respuesta2.lower() == "salir corriendo" or respuesta2.lower() == "Correr":
     ...
     print ("Respuesta no valida, por favor escribe 'seguir'o 'salir corriendo'.")
respuesta3 = input("Quieres agarrar los vidrios o no? (Si o No):")
...
elif respuesta3.lower () == "no" or respuesta2.lower () == "no agarrar los vidrios":
     print ("Decides no agarrar los vidrios y las personas que se acercan son participantes como tu, te atacan y mueres.")
     print ("Has muerto.")
else: 
     print ( "Respuesta no valida, por favor escribe 'si'o 'no'.")
respuesta4 = input("Quieres agarrar el botiquin, la linterna o el cuchillo? (Botiquin, Literna o Cuchillo):")
if respuesta4.lower() == "botiquin":
     print ("Decides agarrar el botiquin y te lo guardas.)")
elif respuesta4.lower() == "linterna":
     print ("Decides agarrar la linterna y te la guardas.")
elif respuesta4.lower() == "cuchillo":
...
respuesta5 = input ("Quieres entrar a la cocina, al comedor o a la sala de estar? (Cocina, Comedor o Sala de estar):")
if respuesta5.lower () == "cocina":
...
elif respuesta5.lower () == "sala de estar":
...
respuesta6 = input("Quieres matarlo con la motosierra, darle el golpe de gracia con un golpe o dejarlo vivir y hablar con el para averiguar mas y aliarse? (Matarlo con la motosierra, Dar golpe, Dejarlo vivir y hablar):")
if respuesta6.lower() == ("matarlo con la motosierra") or respuesta6.lower() == ("motosierrra"):
...
elif respuesta6.lower() == ("dar golpe") or respuesta6.lower() == ("dar golpe de gracia"):
...
elif respuesta6.lower() == ("dejarlo vivir y hablar") or respuesta6.lower() == ("hablar"):
